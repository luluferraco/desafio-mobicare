...
protocol ListTransactionsDisplayLogic: class {
	func displaySomething(viewModel: ListTransactions.Something.ViewModel)
}

class ListTransactionsViewController: UITableViewController, ListTransactionsDisplayLogic {
	...
	func doSomething() {
		let request = ListTransactions.Something.Request()
